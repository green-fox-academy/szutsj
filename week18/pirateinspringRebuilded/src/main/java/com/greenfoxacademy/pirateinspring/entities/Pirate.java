...
public class Pirate {
  ...
  private boolean selectedToFightWith;
  ...
  public boolean isSelectedToFightWith() {
    return selectedToFightWith;
  }

  public void setSelectedToFightWith(boolean selectedToFightWith) {
    this.selectedToFightWith = selectedToFightWith;
  }
  ...
  public String toString() {
    return "Pirate{" +
        ...
        ", selected=" + selected +
        ", selectedToFightWith=" + selectedToFightWith +
        '}';
  }
}
