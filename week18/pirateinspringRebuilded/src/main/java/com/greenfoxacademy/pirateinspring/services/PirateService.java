...
public class PirateService {
  ...
  public String brawl(Pirate pirate, Pirate enemy, GameService gameService){
    if (!enemy.isAlive() || enemy.isPassedOut() || !pirate.isAlive() || pirate.isPassedOut()){
      ...
      int resultOfBrawl = (int)(Math.random() * 10);
      if (resultOfBrawl == 0){
        die(enemy);
        gameService.setWinnedBrawl(gameService.getWinnedBrawl() + 1);
        return "Our pirate has won.";
      } else if (resultOfBrawl == 1){
        die(pirate);
        return "Our pirate has lost.";
      } else if (resultOfBrawl == 2){
        enemy.setPassedOut(true);
        gameService.setWinnedBrawl(gameService.getWinnedBrawl() + 1);
        return "Our pirate has won.";
      } else if (resultOfBrawl == 4){
        enemy.setPassedOut(true);
        gameService.setWinnedBrawl(gameService.getWinnedBrawl() + 1);
        return "Our pirate has won.";
      } else if (resultOfBrawl == 5) {
        pirate.setPassedOut(true);
        return "Our pirate has lost.";
      } else if (resultOfBrawl == 6) {
        pirate.setPassedOut(true);
        return "Our pirate has lost.";
      } else {
        enemy.setPassedOut(true);
